...
- [Homelab Network Documentation](#homelab-network-documentation)
  ...
  - [6 · Physical Network Topology](#6--physical-network-topology)
    - [Proxmox VM Group (on `bill-the-pony.shire`, 10.136.20.10)](#proxmox-vm-group-on-bill-the-ponyshire-101362010)
  ...
  - [9 · Virtual Machines — Proxmox (`bill-the-pony.shire`)](#9--virtual-machines--proxmox-bill-the-ponyshire)
    - [VM Notes](#vm-notes)
  - [10 · IoT Devices — VLAN 30](#10--iot-devices--vlan-30)
    - [Proudfoot Family — Temperature \& Humidity Sensors (ESP8266)](#proudfoot-family--temperature--humidity-sensors-esp8266)
    - [Took Family — Smart Plugs](#took-family--smart-plugs)
...
### Proxmox VM Group (on `bill-the-pony.shire`, 10.136.20.10)
