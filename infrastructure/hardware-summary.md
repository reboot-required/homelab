[Home](../README.md) › [Infrastructure](README.md) › Hardware Summary

# Hardware Summary

This page documents all physical devices in the homelab: their hardware specifications, assigned roles, estimated power consumption, and network placement.

For authoritative hostname and IP assignments, see [node-registry.md](node-registry.md).
...
| N150 Mini-PC | `bill-the-pony.shire` | Proxmox VE Hypervisor | | 8 | 30 | 166 |
| Cel3867U Mini-PC | `isengard.shire` | K3s Master Node | | 7 | 25 | 140 |
| N150 Mini-PC | `rohan.shire` | K3s Worker Node 1 | | 8 | 30 | 166 |
| N150 Mini-PC | `gondor.shire` | K3s Worker Node 2 | | 8 | 30 | 166 |
...
| Device | Hostname | Role | Notes | Idle (W) | Peak (W) | kWh/Year (≈avg) |
|---|---|---|---|---:|---:|---:|
| Mac Mini M4 | `valinor.shire` | LLM Server (LM Studio + OpenWebUI) | | 10 | 50 | 263 |
...
For detailed VLAN configuration, IP assignments, switch port layout, and network topology, see [networking/overview.md](../networking/overview.md).
...
See [rack-layout.md](rack-layout.md) for a full ASCII diagram.
